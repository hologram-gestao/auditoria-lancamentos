...
/**
 * Error boundary da rota "Carteira" do cliente.
 *
...
export default function ClientTitlesError({
  error,
  reset,
  params,
}: {
  ...
  useEffect(() => {
    ...
    console.error('[clientes/carteira] erro na rota', error);
  }, [error]);
    ...
    >
      <div className="space-y-1.5">
        {/* `h2` pelo mesmo motivo do `AccessDenied`: o shell do cliente já
            rende o `h1`. */}
        <h2 className="text-lg font-semibold">Não foi possível carregar a carteira</h2>
